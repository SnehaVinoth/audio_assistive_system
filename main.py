...
"""
    ...
    try:
        response = ollama.chat(
            model='llama3',  # Make sure you have this model
            messages=[
...
# --- NEW FUNCTION FOR ACCESSIBLE CAPTURE ---
def capture_image_with_voice_command():
    ...
    while True:
        ...
        command = get_voice_input().lower() # Get voice command
        ...
        if "capture" in command:
            ...
            # Re-prompts the user if command wasn't understood
...
def main():
    ...
    # If capture was cancelled or failed, exit
